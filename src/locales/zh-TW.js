...
const lang = {
    ...
    CustomizedTopic: '自定義主題',
    CommonlyComponent: '常用組件',
    ...
    SuccessCreate: '成功新增',
    Remove: '移除',
    RemoveComponent: '移出組件',
    SuccessRemove: '成功移除',
    Edit: '編輯',
    SuccessEdit: '成功編輯',

    Confirm: '確定',
    ConfirmRemove: '確定要移除此',
    ConfirmRemove2: '確定移除',
